  ...
  <div class="h-[100dvh] flex flex-col">
    ...
    <div class="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between z-20">
      <div class="flex items-center gap-3">
        <NuxtLink to="/dashboard" class="p-2 -ml-2 rounded-full hover:bg-gray-100">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-gray-600">
            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
          </svg>
        </NuxtLink>
        <h1 class="font-bold text-gray-900 text-lg">🏥 Vétérinaires proches</h1>
      </div>
      <button @click="locateMe" class="p-2 bg-primary-100 text-primary-600 rounded-full" :disabled="locating">
