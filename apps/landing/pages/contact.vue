      ...
      <div class="grid lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div class="space-y-6">
          <div class="card">
            ...
            <ul class="space-y-3">
              <li>
                <a href="mailto:contact@ficabot.com" class="flex items-center gap-3 text-sm text-gray-700 hover:text-primary-700 transition-colors">
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Une question, un bug, une suggestion ? Écrivez à l\'équipe Ficabot.' },
  ],
})
